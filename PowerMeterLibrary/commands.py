...
class Commands(Enum):
    ...
    SET_CURRENT_OPTICAL_POWER_AS_REFERENCE              = b'\xAA\x02\x13\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
    SWITCH_LED_BACKLIGHT                                = b'\xAA\x02\x04\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'
